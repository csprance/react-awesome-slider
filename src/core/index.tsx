...
interface Props {
  ...
  media: any[],
  name: string,
  onFirstMount: (slider: any)=> void,
  onResetSlider: (slider: any)=> void,
  onTransitionEnd: (slider: any)=> void,
  onTransitionStart: (slider: any)=> void,
...
export default class AwesomeSlider extends React.Component<Props, State> {
